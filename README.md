...
5. Add destinations, source targets (all active, tags, audience-size range/minimum, or manual IDs), mode, and schedule through their own guided controls. The Network screen shows active, unavailable, paused, and attention-required channel counts, accepts a forwarded channel post for manual repair/registration, and ranks the **Top 15** or **Top 30 channels by subscribers** from their last verified member counts.
