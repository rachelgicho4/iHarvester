...
from app.telegram.handlers_owner import campaign_keyboard, content_type_keyboard
...
def test_guided_creator_uses_callback_controls_not_pipe_delimited_commands() -> None:
    ...
    assert {"CTA buttons", "Destinations", "Targets", "Schedule", "Review & launch"} <= set(campaign_controls)
